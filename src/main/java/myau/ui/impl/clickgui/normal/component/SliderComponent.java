...
import myau.ui.impl.clickgui.normal.Component;
...
public class SliderComponent implements Component {
    ...
    public void mouseDown(int x, int y, int button) {
        if (this.isTextHovered(x, y) && button == 0 && this.parentModule.panelExpand) {
            GuiInput.prompt(slider.getName().replace("-", " "), slider.getValueString(), slider::setValueString, ClickGuiScreen.getInstance());
            return;
        }
