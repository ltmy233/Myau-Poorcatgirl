...
import myau.ui.impl.clickgui.normal.component.CategoryComponent;
...
public class ClickGuiScreen extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float p) {
        ...
        mc.fontRendererObj.drawStringWithShadow("哇猫娘喵喵喵喵喵", 4, this.height - 3 - mc.fontRendererObj.FONT_HEIGHT, new Color(60, 162, 253).getRGB());
