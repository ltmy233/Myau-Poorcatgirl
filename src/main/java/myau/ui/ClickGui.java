...
public class ClickGui extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float p) {
        ...
        mc.fontRendererObj.drawStringWithShadow("MyauPoorcatgirl " + Myau.version, 4, this.height - 3 - mc.fontRendererObj.FONT_HEIGHT * 2, new Color(60, 162, 253).getRGB());
        mc.fontRendererObj.drawStringWithShadow("dev, ltmy_233", 4, this.height - 3 - mc.fontRendererObj.FONT_HEIGHT, new Color(60, 162, 253).getRGB());
