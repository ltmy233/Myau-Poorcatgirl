...
public class DynamicIsland extends Module { // nah bro i took 2 hour just to did this shit
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        String text = "cat  ·  " + username + "  ·  " + ping + "ms to " + server + "  ·  " + fps + "fps";
        ...
        float part1Width = mc.fontRendererObj.getStringWidth("cat");
        mc.fontRendererObj.drawStringWithShadow(
                part1,
        ...
        float part2Width = mc.fontRendererObj.getStringWidth("cat" + part1);
        mc.fontRendererObj.drawStringWithShadow(
                part2,
        ...
        float restWidth = mc.fontRendererObj.getStringWidth("cat" + part1 + part2);
        mc.fontRendererObj.drawStringWithShadow(
                rest,
